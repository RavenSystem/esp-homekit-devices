...
Changes:
- Updated FreeRTOS version from 10.2.0 to 10.4.3.
- Updated LwIP version from 2.0.3 to 2.2.0 (https://github.com/ourairquality/lwip)
- Disable native Wifi sysparam by default.
- Change Timer task priority from 2 to 3.

## Original esp-open-rtos
