...
"</style></head><body><div class=\"container\"><h1>Home Accessory Architect<br>v"HAA_FIRMWARE_VERSION""HAA_FIRMWARE_BETA_REVISION" "HAA_FIRMWARE_CODENAME" "HAA_CHIP_NAME""HAA_SINGLE_CORE_SUFIX"</h1>"
"<h2>(Installer ";
