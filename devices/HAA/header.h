...
#define WIFI_ARP_RESEND_PERIOD              (20)    // * WIFI_WATCHDOG_POLL_PERIOD_MS
#define WIFI_ARP_RESEND_MARGIN              (10)    // * WIFI_WATCHDOG_POLL_PERIOD_MS
#define WIFI_ROAMING_PERIOD                 (1950)  // + MARGIN      * WIFI_WATCHDOG_POLL_PERIOD_MS
#define WIFI_ROAMING_MARGIN                 (300)   // * WIFI_WATCHDOG_POLL_PERIOD_MS
