...
#define WIFI_RECONNECTION_POLL_PERIOD_MS    (4000)
#define WIFI_DISCONNECTED_LONG_TIME         (30)    // * WIFI_RECONNECTION_POLL_PERIOD_MS

#define WIFI_WATCHDOG_POLL_PERIOD_MS        (1500)
#define WIFI_WATCHDOG_ARP_RESEND_PERIOD     (13)    // * WIFI_WATCHDOG_POLL_PERIOD_MS
#define WIFI_WATCHDOG_ARP_RESEND_MARGIN     (10)    // * WIFI_WATCHDOG_POLL_PERIOD_MS
#define WIFI_WATCHDOG_ROAMING_PERIOD        (1300)  // * WIFI_WATCHDOG_POLL_PERIOD_MS
#define WIFI_WATCHDOG_ROAMING_MARGIN        (200)   // * WIFI_WATCHDOG_POLL_PERIOD_MS
