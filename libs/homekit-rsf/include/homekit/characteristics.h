...
#define HOMEKIT_DECLARE_CHARACTERISTIC_FIRMWARE_REVISION_STATIC(revision, ...) \
    .type = HOMEKIT_CHARACTERISTIC_FIRMWARE_REVISION, \
    .format = HOMEKIT_FORMAT_STRING, \
    .permissions = HOMEKIT_PERMISSIONS_PAIRED_READ, \
    .value = HOMEKIT_STRING_(revision, .is_static=true), \
    ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_MANUFACTURER_STATIC(manufacturer, ...) \
    .type = HOMEKIT_CHARACTERISTIC_MANUFACTURER, \
    .format = HOMEKIT_FORMAT_STRING, \
    .permissions = HOMEKIT_PERMISSIONS_PAIRED_READ, \
    .value = HOMEKIT_STRING_(manufacturer, .is_static=true), \
    ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_MODEL_STATIC(model, ...) \
    .type = HOMEKIT_CHARACTERISTIC_MODEL, \
    .format = HOMEKIT_FORMAT_STRING, \
    .permissions = HOMEKIT_PERMISSIONS_PAIRED_READ, \
    .value = HOMEKIT_STRING_(model, .is_static=true), \
    ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SERIAL_NUMBER_STATIC(serial, ...) \
    .type = HOMEKIT_CHARACTERISTIC_SERIAL_NUMBER, \
    .format = HOMEKIT_FORMAT_STRING, \
    .permissions = HOMEKIT_PERMISSIONS_PAIRED_READ, \
    .value = HOMEKIT_STRING_(serial, .is_static=true), \
    ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_VERSION_STATIC(_value, ...) \
    .type = HOMEKIT_CHARACTERISTIC_VERSION, \
    .format = HOMEKIT_FORMAT_STRING, \
    .permissions = HOMEKIT_PERMISSIONS_PAIRED_READ, \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CONFIGURED_NAME_STATIC(_value, ...) \
    .type = HOMEKIT_CHARACTERISTIC_CONFIGURED_NAME, \
    .format = HOMEKIT_FORMAT_STRING, \
    .permissions = HOMEKIT_PERMISSIONS_PAIRED_READ \
                 | HOMEKIT_PERMISSIONS_PAIRED_WRITE \
