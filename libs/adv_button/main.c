...
void user_init(void) {
    ...
    adv_button_create(BUTTON_GPIO, true, false, ADV_BUTTON_NORMAL_MODE, 0);
    ...
    adv_button_create(TOGGLE_GPIO, true, false, ADV_BUTTON_NORMAL_MODE, 0);
    adv_button_register_callback_fn(TOGGLE_GPIO, toggle_callback, INVSINGLEPRESS_TYPE, NULL, 0);    // Low edge
    adv_button_register_callback_fn(TOGGLE_GPIO, toggle_callback, SINGLEPRESS_TYPE, NULL, 0);       // High edge
}
